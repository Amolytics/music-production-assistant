...
function VoiceGeneratorPage() {
  ...
  return (
    <div className="central-page">
      <HamburgerMenu />
      <h2 className="voice-tuning-title">Voice Generator</h2>
      ...
      <button onClick={handleGenerate} className="voice-tuning-button">
        Generate Voice
      </button>
      {result && (
        <div className="voice-result">
          <h3>Voice Generation Result</h3>
          {/* You can render audio or result info here */}
